...
export default function Mobile() {
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">WhatsApp Mobile Integration</h1>
      <p className="text-gray-600">
        Halaman ini akan menampilkan dashboard untuk menghubungkan aplikasi dengan WhatsApp mobile Anda.
      </p>
    </div>
  );
}
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Cara menggunakan WhatsApp mobile untuk mengakses aplikasi KP2A
          </CardDescription>
        </CardHeader>
        <CardContent>
